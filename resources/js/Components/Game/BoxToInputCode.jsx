...
export default function BoxToInputCode({title, subtitle, action, error}){
...
//     return (
//         //Parent dibikin w-screen
//         <div className="flex flex-col justify-center items-center w-3/4 lg:w-1/2 h-[400px] rounded-xl bg-white z-10">
//             <form
//                 action={action}
//                 method="post"
