...
//                 </div>
//                 {error && (
//                     <div id="subtitle" className="text-red-500 text-sm">
//                         {error}
//                     </div>
//                 )}
//                 <input
...
//                 >
//                     <div className="absolute flex justify-center items-center w-full h-full top-0 left-0 rounded-md bg-dark-blue z-10">
//                         SUBMIT
//                     </div>
//                     <div className="absolute w-full h-full top-1 left-1 rounded-md bg-black z-0"></div>
//                     <Image
//                         src="/images/cursorBlue.svg"
//                         pos={"absolute"}
//                         boxSize={"4rem"}
//                         bottom={"-1.5rem"}
//                         right={"-2rem"}
